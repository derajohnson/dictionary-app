...
const testimonials = [
  {
    ...
    content: 'Using glossary has been a blessing to me. Looking up words so i can be able to write clear and concise documentation and articles for my readers💡.',
  ...
  },
  {
    ...
    content: 'Glossary has helped me peronsally as a teacher and has also helped my students in understanding words that seemed difficult to them at first🌈.',
  ...
  },
  {
    ...
    content: 'Glossary helped me during my first years of college and it is still helping me! i highly recommend it💯.',
  ...
  },
  {
    name: 'Daniel T.',
    role: 'Lawyer',
    content: 'Great product. Very easy to use and very concise👏.',
